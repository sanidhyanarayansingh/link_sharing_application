    ...
    <div class="row">
        ...
        <div class="col-lg-7">
                ...
                <div class="panel-body">
                    <g:form controller="user" action="update" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control" name="firstname" placeholder="${loggeduser.firstName}" required>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-lg-4 control-label">Last Name* </label>
                            <div class="col-lg-8">
                                <input class="form-control" type="text" name="lastname" placeholder="${loggeduser.lastName}" required>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <button type="submit" name="register" class="btn btn-primary" align="right" data-toggle="modal" data-target="#myModal6">Update</button>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <g:form controller="user" action="updatepassword" class="form-horizontal" method="post">
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-8"></div>
                            <div class="col-lg-4">
                                <button type="submit" name="register" class="btn btn-primary" align="right" data-toggle="modal" data-target="#myModal7">Update</button>
